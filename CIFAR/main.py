...
cifar10dvs_arg.T = 12
cifar10dvs_arg.rank = 8
cifar10dvs_arg.b = 32
cifar10dvs_arg.epoch = 200
cifar10dvs_arg.num_class = 10
experiment = DVSBasedExperiment("CIFAR10DVS_T12_r8", cifar10dvs_arg)
net = VGG.VGG_CIFAR(T=cifar10dvs_arg.T, rank=cifar10dvs_arg.rank, device=cifar10dvs_arg.device).to(cifar10dvs_arg.device)
...
# net = VGG.VGG_Gesture(T=cifar10dvs_arg.T, rank=cifar10dvs_arg.rank, device=cifar10dvs_arg.device).to(cifar10dvs_arg.device)
